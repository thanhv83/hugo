...
git add .
git commit -m "V1"
# kết nối VS code với Github:
git init
git branch -M main
git add .
git commit -m "V1"
git remote add origin https://github.com/thanhv83/website.git
